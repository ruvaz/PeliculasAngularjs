        ...
        execute: function() {
            PeliculasService = (function () {
                ...
                PeliculasService.prototype.getPeliculas = function () {
                    return mock_peliculas_1.getMockPeliculasArr;
                };
                PeliculasService.prototype.insertPelicula = function (pelicula) {
                    Promise.resolve(mock_peliculas_1.getMockPeliculasArr).then(function (peliculas) { return peliculas.push(pelicula); });
                };
